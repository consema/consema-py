...
- https://github.com/consema/consema-rs/blob/main/consema-hcl/src/*.rs for byte/registry arbitration only;
- https://github.com/consema/consema-go/blob/main/go/hcl as a cross-reference only (never a template).
