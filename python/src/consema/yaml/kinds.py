...
- Profiles: RFC 0007 §1 (https://github.com/consema/consema/blob/main/docs/rfcs/0007-yaml-family-profiles-and-safety-v1.md)
...
- Syntax kinds: RFC 0007 §9 (lines 224-228: BOM, Directive,
  ...
  lib.rs.
- Node kinds: lib.rs (Scalar/Sequence/Mapping); scalar styles
  lib.rs (Plain/SingleQuoted/DoubleQuoted/Literal/Folded);
  scalar categories lib.rs (Null/Boolean/Integer/Float/String/
...
class YamlProfile(enum.Enum):
    ...
    def accepted_version(self) -> str:
        """Accepted ``%YAML`` version spelling (lib.rs)."""
        return {
