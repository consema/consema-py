...
Authority: RFC 0016 §4.1/§4.2; https://github.com/consema/consema-rs/blob/main/consema-pvce/src/lib.rs (byte
arbitration); conformance/vectors/v1.json (golden bytes); https://github.com/consema/consema-go/blob/main/go/core as a
