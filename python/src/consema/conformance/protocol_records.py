...
crate (https://github.com/consema/consema-rs/blob/main/consema-protocol/src/execution.rs, projection.rs, query.rs,
change.rs — the registry/byte authority), with https://github.com/consema/consema-go/blob/main/go/protocol (records_*.go)
