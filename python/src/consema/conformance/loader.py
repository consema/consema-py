...
runner's exact conventions (https://github.com/consema/consema-go/blob/main/go/conformance/conformance.go):
...
https://github.com/consema/consema-go/blob/main/go/conformance/conformance.go):
