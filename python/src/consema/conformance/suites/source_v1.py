...
mirroring https://github.com/consema/consema-go/blob/main/go/conformance/source_v1.go.
"""
...
def _encoding_request(vector: runner.Case) -> EncodingRequest | None:
    ...
    encoding facts (https://github.com/consema/consema-go/blob/main/go/conformance/source_v1.go sourceEncodingRequest)."""
