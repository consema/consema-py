...
https://github.com/consema/consema-rs/blob/main/consema-conformance/src/lib.rs and https://github.com/consema/consema-go/blob/main/go/conformance). The import
