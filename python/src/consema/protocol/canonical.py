...
https://github.com/consema/consema-rs/blob/main/consema-protocol/src/value_transport.rs (the byte arbitration
source); conformance/vectors/protocol-v1.json and protocol-v2.json carry the
shared transport cases. Go (https://github.com/consema/consema-go/blob/main/go/protocol/canonical.go) is a cross-reference.
