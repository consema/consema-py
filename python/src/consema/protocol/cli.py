...
the record validation in https://github.com/consema/consema-rs/blob/main/consema-protocol/src/cli.rs. Go
(https://github.com/consema/consema-go/blob/main/go/protocol/cli.go, cli_json.go) is a cross-reference only.
...
class SourcePatchLimits:
    ...
    https://github.com/consema/consema-rs/blob/main/consema-protocol/src/cli.rs from_value_with_registry patch_limits
    parameter; https://github.com/consema/consema-go/blob/main/go/protocol/records_source.go DefaultSourcePatchLimits):
