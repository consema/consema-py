...
Authority: RFC 0015/0016; https://github.com/consema/consema-rs/blob/main/consema-protocol (registry arbitration and
byte behavior); conformance/vectors (protocol-v1.json, protocol-v2.json,
cli-v1.json); https://github.com/consema/consema-go/blob/main/go/protocol as a cross-reference only.
"""
