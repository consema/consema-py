...
- https://github.com/consema/consema-rs/blob/main/consema-plist/src/*.rs for byte/registry arbitration only;
- https://github.com/consema/consema-go/blob/main/go/plist as a cross-reference only (never a template).
