...
test); https://github.com/consema/consema-rs/blob/main/consema-xml/src/materialization.rs (byte/registry
arbitration); RFC 0012 §10 (https://github.com/consema/consema/blob/main/docs/rfcs/0012-xml-1.0-safe-profile-v1.md:
...
def test_vector_invalid_record_rejected(xml_vectors):
    ...
    https://github.com/consema/consema-rs/blob/main/consema-conformance/src/xml_v1.rs:860-871)."""
