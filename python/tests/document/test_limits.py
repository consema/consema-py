...
Frozen defaults:
- SourceLimits: https://github.com/consema/consema-rs/blob/main/consema-document/src/source.rs:401-409 (64 MiB raw,
  128 MiB decoded UTF-8, 64 MiB decoded scalars);
- ParseLimits: https://github.com/consema/consema-rs/blob/main/consema-document/src/lib.rs:629-639 (64 MiB source,
  depth 256, 2M tokens, 1M nodes, 10k diagnostics) — also pinned by
  RFC 0016 §5.1 and https://github.com/consema/consema-go/blob/main/go/document/limits.go (cross-reference);
- MaterializationLimits: https://github.com/consema/consema-rs/blob/main/consema-document/src/materialization.rs:95-105
  (1M input nodes, 64 MiB output, depth 256, 100k report, 2M provenance);
- SourcePatchLimits: https://github.com/consema/consema-rs/blob/main/consema-document/src/source_patch.rs:19-27
