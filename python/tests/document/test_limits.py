...
Frozen defaults:
- SourceLimits: https://github.com/consema/consema-rs/blob/main/consema-document/src/source.rs (64 MiB raw,
  128 MiB decoded UTF-8, 64 MiB decoded scalars);
- ParseLimits: https://github.com/consema/consema-rs/blob/main/consema-document/src/lib.rs (64 MiB source,
...
- MaterializationLimits: https://github.com/consema/consema-rs/blob/main/consema-document/src/materialization.rs
  (1M input nodes, 64 MiB output, depth 256, 100k report, 2M provenance);
- SourcePatchLimits: https://github.com/consema/consema-rs/blob/main/consema-document/src/source_patch.rs
